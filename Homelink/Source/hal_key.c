...
#define HAL_KEY_DEBOUNCE_VALUE  800
...
#define HAL_KEY_SW_6_BIT    (BV(2) | BV(3) | BV(4) | BV(5) | BV(6) | BV(7))
#define HAL_KEY_SW_6_SEL    P1SEL
#define HAL_KEY_SW_6_DIR    P1DIR

/* edge interrupt */
#define HAL_KEY_SW_6_EDGEBIT  (BV(1) | BV(2))
...
#define HAL_KEY_SW_6_ICTLBIT  (BV(2) | BV(3) | BV(4) | BV(5) | BV(6) | BV(7)) /* P1IEN - P1.2-P1.7 enable/disable bit */
...
void HalKeyConfig (bool interruptEnable, halKeyCBack_t cback)
{
  ...
  if (Hal_KeyIntEnable)
  {
    ...
    HAL_KEY_SW_6_PXIFG = (char)~(HAL_KEY_SW_6_BIT);
    /* Rising/Falling edge configuratinn */
  ...
  /* If buttons pressed while booting fire off event */
  halKeySavedKeys = HalKeyRead();
...
void halProcessKeyInterrupt (void)
{
  ...
  {
    HAL_KEY_SW_6_PXIFG = (char)~(HAL_KEY_SW_6_BIT); /* Clear Interrupt Flag */
    valid = TRUE;
  }
